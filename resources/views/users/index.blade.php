...
@section('content')
    <section class="container px-4 mx-auto">
        ...
        @if (session('success'))
            <div class="flex w-full max-w-sm overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800 mb-14">
        ...
        <div class="space-x-4">
            ...
            <a href="{{ route('index') }}"
                class="px-6 mb-10 py-2 font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-600 rounded-lg hover:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-80">
                Voltar pra home</a>
        ...
        <h2 class="text-lg font-medium text-gray-800 dark:text-white my-10 ">Lista de usários</h2>
                                ...
                                @foreach ($users as $user)
                                    <tr>
                                        <td class="px-4 py-4 text-sm font-medium whitespace-nowrap">
                                            <div>
                                                <h2 class="font-medium text-gray-800 dark:text-white ">{{ $user->name }}
                                                </h2>
